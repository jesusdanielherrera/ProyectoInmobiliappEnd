      ...
      <div class="container-fluid"> 
        ...
        <div class="row"> 
          ...
          <h4>Agregar Registros</h4>
            <a type="button" class="btn btn-danger" href="RegistrarVentasA.php">Registrar Venta</a>
            <a type="button" class="btn btn-danger" href="RegistrarArriendoA.php">Registrar Arriendo</a>
          </div>
           <div class="col">
             <h4>Registros realizados</h4>
              <a href="VentasrealizadasA.php" type="button" class="btn btn-danger">Registro de Ventas</a>
